...
raspivid -md 7 -t $1 -fps 180 -h 64 -w 640 -pts $2_tstamps.txt --flush -lev 4.2 -ex off -awb off -ag 6 -dg 0.2 -awbg 1.5,1.9 -ss 5000 --initial pause --signal --nopreview -o $2.h264
